...
│                            [شعار] غزة في القلب                     │
├─────────────────┬─────────────────┬─────────────────┬──────────────┤
│    الحملات     │  عن المبادرة    │   كيف تدعم      │  تواصل معنا │
└─────────────────┴─────────────────┴───────────────┴─────┬──────────┘
                                                           │
                                                    [تبرع الآن - زر لونه أخضر فاتح]
┌─────────────────────────────────────────────────────────────────────┐
│                                                                     │
│                    [صورة تعبيرية: قلب بألوان فلسطين أو أيقونات أمل]│
│                                                                     │
│                        دعم أهل غزة في محنتهم                        │
│          نجمع لك الحملات الموثوقة على منصة GoFundMe                │
│               لضمان وصول تبرعك مباشرة إلى من يحتاجه                │
│                                                                     │
│                  [زر كبير: استعرض الحملات]                         │
│                  [زر ثانوي: كيف نضمن الوصول؟]                      │
└─────────────────────────────────────────────────────────────────────┘

┌─────────────────────────────────────────────────────────────────────┐
│                     كيف تعمل المبادرة؟                             │
├─────────────────┬─────────────────┬─────────────────┬──────────────┤
│  [أيقونة بحث]   │  [أيقونة تحقق]  │  [أيقونة تبرع]  │ [أيقونة تتبع]│
│  اختر حملة      │  حملات موثوقة   │  تبرع مباشر     │  تتبع أثرك   │
│  من القائمة     │  تم التحقق منها │  وآمن           │              │
└─────────────────┴─────────────────┴─────────────────┴──────────────┘

┌─────────────────────────────────────────────────────────────────────┐
│                     الحملات النشطة                                 │
│    اختر إحدى الحملات الموثوقة وساهم في دعم أهل غزة                │
├─────────────────────────────────────────────────────────────────────┤
│  ┌─────────────────────────────────────────────────────────────┐   │
│  │  [أيقونة طبية]  🔵 تم التحقق                                │   │
│  │  دعم طبي - توفير الأدوية والمستلزمات الطبية                │   │
│  │  توفير الأدوية والمستلزمات الطبية الأساسية للمستشفيات     │   │
│  │                                                             │   │
│  │  ✅ $42,800 تم جمعه من $50,000 الهدف                        │   │
│  │  [شريط التقدم: 85% مملوء]                                   │   │
│  │  [زر: ساهم في هذه الحملة]                                  │   │
│  └─────────────────────────────────────────────────────────────┘   │
│                                                                    │
│  ┌─────────────────────────────────────────────────────────────┐   │
│  │  [أيقونة طعام]  🔵 تم التحقق                                │   │
│  │  دعم غذائي - توفير الغذاء الطارئ                            │   │
│  │  حملة لتوفير الطعام الأساسي للأسر المتضررة                 │   │
│  │                                                             │   │
│  │  ✅ $18,500 تم جمعه من $25,000 الهدف                        │   │
│  │  [شريط التقدم: 74% مملوء]                                   │   │
│  │  [زر: ساهم في هذه الحملة]                                  │   │
│  └─────────────────────────────────────────────────────────────┘   │
└─────────────────────────────────────────────────────────────────────┘
...
┌─────────────────────────────────────────────────────────────────────┐
│                      نضمن وصول تبرعك                               │
│  ✅ جميع الحملات تم التحقق منها عبر فريقنا                        │
│  ✅ الأموال تصل مباشرة للمحتاجين دون وساطة                         │
│  ✅ تقارير شهرية عن تأثير التبرعات                                │
│  ✅ شركاء موثوقون: [شعارات شركاء إن وجدت]                         │
└─────────────────────────────────────────────────────────────────────┘

┌─────────────────────────────────────────────────────────────────────┐
│                     غزة في القلب                                   │
│  تبرع الآن | عن المبادرة | الأسئلة الشائعة | سياسة الخصوصية      │
│  © 2023 جميع الحقوق محفوظة                                         │
│  [أيقونات وسائل التواصل الاجتماعي]                               │
└─────────────────────────────────────────────────────────────────────┘

[زر عائم دائم في الزاوية السفلية: تبرع الآن 🟢]</head>
<body>
    <!-- شريط التنقل -->
    <nav class="navbar">
        <div class="container">
